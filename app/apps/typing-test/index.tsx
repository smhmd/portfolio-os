...
const sentences = `But this was too much. The wolf danced about with rage and swore he would come down the chimney and eat up the little pig for his supper. But while he was climbing on to the roof the little pig made up a blazing fire and put on a big pot full of water to boil. Then, just as the wolf was coming down the chimney, the little piggy pulled off the lid, and plop! In fell the wolf into the scalding water.`
...
export default function TypingTest() {
  ...
  return (
    <AppWraper className='flex flex-col items-center justify-center gap-6 bg-[whitesmoke] p-4 font-mono text-black'>
 ...
 */
function Timer({ enabled = true, initialSeconds = 0 }: TimerProps) {
