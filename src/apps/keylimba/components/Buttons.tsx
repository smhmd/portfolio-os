...
export function MenuButton(props: BaseButtonProps) {
  return (
    <BaseButton aria-label='Open Settings' {...props}>
      <svg
        aria-hidden
        focusable='false'
        strokeLinecap='round'
...
export function RecordButton(props: BaseButtonProps) {
  return (
    <BaseButton aria-label='Record' {...props}>
...
export function PlayButton(props: BaseButtonProps) {
  return (
    <BaseButton aria-label='Play Recording' {...props} animation='spin'>
      <svg aria-hidden focusable='false' viewBox='0 0 24 24'>
        <path
          fill='#000'
          fillOpacity='.3'
...
export function ResetButton(props: BaseButtonProps) {
  return (
    <BaseButton aria-label='Reset Record' {...props} animation='fill'>
      <svg aria-hidden focusable='false' viewBox='0 0 24 24'>
        <rect
          width='18.5'
          height='18.5'
...
export function DownloadLink(props: BaseLinkProps) {
  return (
    <BaseLink aria-label='Download recording' {...props}>
      <svg aria-hidden focusable='false' viewBox='0 0 24 24'>
        <path
          fill='#000'
          fillOpacity='.3'
...
export function ProgressIcon({
  ...
  return (
    <svg aria-hidden focusable='false' viewBox='0 0 40 40' {...props}>
      <path
  ...
  return (
    <span
      ...
      className={clsx(
        ...
        'group-hocus:scale-100 group-hocus:opacity-100',
